...
class RPNAccMetric(mx.metric.EvalMetric):
    def __init__(self, pred_idx=-1, label_idx=-1,):
        ...
        self.name = ['M{}_'.format(self.stride)+'RPNAcc', 'M{}_'.format(self.stride)+'RPNAccFG']
    ...
    def update(self, labels, preds):
        ...
        if isinstance(self.name, str):
          ...
          # _pred_label = pred_label[keep_inds]
          # _label = label[keep_inds]
          # self.sum_metric[2] += np.sum(_pred_label.flat == _label.flat)
          # self.num_inst[2] += len(_pred_label.flat)
